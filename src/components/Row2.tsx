 ...
 */
export default React.memo(DraggableRow2, (prevProps, nextProps) => {
  const ret = prevProps.product === nextProps.product && prevProps.columnsConfig===nextProps.columnsConfig
