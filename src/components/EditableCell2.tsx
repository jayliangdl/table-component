...
export interface EditableCellProps {
  ...
  onEdit: (dataIndexInGroup: number) => Promise<void>;
  onDelete: (id: Id) => Promise<void>;
  onColumnValueChange: (columnName:string,updatedValue:any)=>void;//回调函数，通知上层父组件（RowCore2），指定更新的columName和最新的值
}



export const EditableCell2:React.FC<EditableCellProps> = ({
    columnEditConfig,
  columnName, indexInGroup, recordId, value, isEditing, isSaving, type="text", editable, disabled = false,readOnly = false,
 ...
 */
export default React.memo(EditableCell2, (prevProps, nextProps) => {
